...
const playlistPageData = [
  {
    ...
    description: "",
    spotifyPlaylist: "https://open.spotify.com/embed/playlist/0obCUHiVzSDUvlruSuNESU?utm_source=generator&theme=0",
    spotifyHeight: '850px',
    songs: [
      {
        song: "Puzzle Box",
  ...
  },
  {
    ...
    description: "This Women's History Month, join us as we spotlight the innovators whose unique voices and bold creativity continue to shape the genre.",
    spotifyPlaylist: "https://open.spotify.com/embed/playlist/5EfpxPOVIsMsSvTjohCiIl?utm_source=generator&theme=0",
    spotifyHeight: '850px',
    songs: [
      {
      ...
      },
      {
        ...
        artistSite:
          "https://phasetransitionofficial.com",
      },
      {
        song: "Holy Ghost",
        artist: "Bent Knee",
  ...
  date: new Date("2025-02-15"),
    description: "",
    spotifyPlaylist: "https://open.spotify.com/embed/playlist/1CzaFCkX5V2YfrUYmiyYA2?utm_source=generator&theme=0",
    spotifyHeight: '800px',
    songs: [
      {
        song: "Firefly",
